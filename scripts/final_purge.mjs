...
async function killLastSunday() {
  const { data, error } = await supabase.from('clases').delete().eq('id', 'd5bb1647-29b6-42f4-8a6a-fcf499b0a843')
  if (error) console.error(error)
  else console.log('KILL COMPLETE: Domingo 22 de marzo eliminado.')
}
